...
//                    y1 = y + 1;
//                    if (arena[x1][y1] == 1) {
//                        if (!before.equalsIgnoreCase("DOWN")) if (findPath(user, x1, y1, "UP")) {
//                            return true;
//                        }
//                    }
//                }
...
//                    y1 = y;
//                    if (arena[x1][y1] == 1) {
//                        if (!before.equalsIgnoreCase("LEFT")) if (findPath(user, x1, y1, "RIGHT")) {
//                            return true;
//                        }
//                    }
//                }
...
//                    y1 = y - 1;
//                    if (arena[x1][y1] == 1) {
//                        if (!before.equalsIgnoreCase("UP")) if (findPath(user, x1, y1, "DOWN")) {
//                            return true;
//                        }
//                    }
//                }
...
//                    y1 = y;
//                    if (arena[x1][y1] == 1) {
//                        if (!before.equalsIgnoreCase("RIGHT")) if (findPath(user, x1, y1, "LEFT")) {
//                            return true;
//                        }
//                    }
//                }
